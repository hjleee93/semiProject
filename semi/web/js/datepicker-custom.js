	...
	k.prototype = {
		...
		getClassNames: function (b) {
			...
			return (
				...
				// console.log("C :" + c),
				// console.log("B :" + b),
				-1 !== this.dates.contains(b) && c.push("active"),//수정
				...
				for (var x, y, z = []; u.valueOf() < w;) {
					...
					this.o.beforeShowDay !== a.noop &&
						...
						z.push(
							...
							'">' +
							//a버튼 추가
							//오늘 날짜 이후 인 td만 a태그 활성화
							(y[0] == "today" || y[0] == "day" ||y[0] == "active" ? '<a class="' +
								'day'  + '"' +'id="' +
								'day' + E + '"'+'value=' +E + ' onclick="' +
								'MyFunction(event)' +'"'+ 'return false; ' + '"' + '>' : "")
							+ '<input id="' + 'day' + E +'"'+ 'type=' +'"hidden"' +'>' +'</input>'+
							E + '</a>'  + '<p'+ (y[0] == "active" || y[1] == "active" ? ' id="' + 'active' :"")+ '"' +'>'  +
							(y[0] == "disabled" ?
								'<div id="' + E + 'disRsv' + '">' + '</div>' : (y[0] == "new" ?
								 '<div id="' + E + 'newRsv' + '">' + '</div>'
									: '<div id="' + 'rsv' + E + '">' + '</div>')) +
							"</td>"
...
//	 console.log('attr :' + $('p[id=active]')); //active때문에 id값이 사려졋다 생겼다함 -> 이걸 고정시켜야함 
	
// 	console.log(event.currentTarget.className);
// 	var name = event.currentTarget.className;
// 	var cName = document.getElementById(name).getAttribute('value');
// 	console.log("cName" + cName);
// 	var idName = cName + 'rsv';
// 	console.log("idName : " + idName);
	
// 	// console.log("inner: " + document.getElementsByClassName(name)[0].getAttribute('value'));
// 	// console.log("class: "+name);
// 	// console.log("value: " + $("a[class=name]").attr("value"));
// 	// console.log("cName: " + cName);
// 	console.log(parent);
...
//	console.log("getElementById: " + document.getElementById(clickedId).getAttribute('value'));
//
//	var name=document.getElementById(clickedId).getAttribute('value');
//	
//	var script = "<script>";
//	script += "function sendData(e){\n";
//	script += "const tr = $(e.target);";
//	script += "var con=opener.document.getElementById('active').value;\n";
////	script += "var name = event.currentTarget.className;";
//	script += "console.log(";
//	script += "'cone: '";
//	script += " + con);\n";
//	script += "console.log(document.getElementById(name));\n";
//	script += "var value=document.getElementById('data').value;\n";
//	script += "$(con).append('<hr>');\n"; 
//	script += ""
//	script += "con.innerHTML='<h2>'+value+'</h2>';}";
//	script += "</";
//	script += "script>";
//	
//	child.document.write("<html> <script type='text/javascript' src='https://code.jquery.com/jquery-1.11.3.min.js'></script><body><h2>부모창에서 작성한 내용</h2><input id='data' type='type'><button onclick='sendData(event);'>데이터전송</button>" 
//	+ script + "</body></html>");
