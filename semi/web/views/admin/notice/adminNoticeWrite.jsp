	...
	enctype="multipart/form-data">
        <table class="tbl-reg">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><label for="notice">분류</label></th>
                    <td>
                        <select id="notice" name="notice" title="공지사항" class="select" disabled>
                ...
                <tr>
                    <th scope="row"><label for="sep">구분</label></th>
                    <td>
                        <select id="sep" name="sep" title="게시판구분" class="select">

                            <option name="sep" id="select0" value="회원" selected>회원</option>
                            <option name="sep" id="select1" value="파트너">파트너</option>
                            <!-- 버튼누르면 고객Q&A/파트너Q&A로 게시글이 등록되게끔 !!!!!!!!!!!!!!!!!!!!!!!!!!-->
                        </select>
                    </td>
                </tr>
                <tr>
