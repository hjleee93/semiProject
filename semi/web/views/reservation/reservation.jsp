...
//일요일이 되면 행(</tr>을 닫고 새로운 행 생성
	...
	<div align="center">
//서버로 보낼 form
//여기서 바로 컨트롤러에서 ModelAttribute 메서드를 통해 매핑해놓은 ${cp}를 사용한다!
	<form name="form1" action="${cp}/reserve/reserveDateOk" >
		<input type="text" name="res_date" readonly="readonly">
//날짜를 클릭하면 javascript res()메서드가 실행되어 text 값이 선택한 년도-월-날짜로 셋팅된다		
        <input type="submit" value="다음" onclick="return check()">
//submit 클릭하면 check()메서드 리턴
//text값이 담겨있으면 submit됨
