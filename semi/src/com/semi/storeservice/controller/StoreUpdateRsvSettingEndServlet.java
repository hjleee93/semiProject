...
/**
 * Servlet implementation class StoreUpdateRsvSettingEndServlet
 */
@WebServlet("/storeService/storeUpdateRsvSettingEnd")
public class StoreUpdateRsvSettingEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StoreUpdateRsvSettingEndServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int result1 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result2 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result3 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result4 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result5 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result6 = new StoreServiceService().updateStoreService(ss);
		...
		ss.setStoreOff(request.getParameter("storeOff"));
		int result7 = new StoreServiceService().updateStoreService(ss);
		...
		if (result1 > 0 && result2 > 0 && result3 > 0 && result4 > 0 && result5 > 0 && result6 > 0 && result7 > 0) {
			msg = "예약 서비스 등록이 완료되었습니다. 마이페이지로 이동합니다.";
//			
			loc = "/partnerpage";
		} else {
			msg = "입력하신 데이터에 오류가 발생했습니다. 마이페이지로 이동합니다.";
			// 신청폼 다시
			loc = "/partnerpage";
		}
